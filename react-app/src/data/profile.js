...
export const PROJECTS = {
  ...
  intro:
    "A selection of systems I've built and designed. Click them to dive into what I built and how it works.",
  items: [
    {
      meta: "2025",
      title: "AI-Powered Document Intelligence System",
      stack: "Python · FastAPI · LangChain · ChromaDB · OpenAI API · Docker",
      lead: "A Retrieval-Augmented Generation (RAG) system that answers contextual queries from uploaded PDF documents with low-latency semantic search.",
      points: [
        "Scalable FastAPI backend for document ingestion, embedding generation, and semantic search.",
        "Vector database pipelines (ChromaDB) for efficient retrieval and low-latency responses.",
        "Improved response relevance via chunking, embedding optimization, and prompt engineering.",
        "Fully containerized with Docker for portable deployment.",
      ],
    },
    {
      meta: "2024 — 2025",
      title: "Scalable Real-Time Feedback Processing System",
      stack: "Python · Kafka · PySpark · MongoDB · Linux",
      lead: "A distributed streaming pipeline processing 10,000+ records/hour with latency under 2 seconds.",
      points: [
        "Kafka-based streaming architecture integrated with PySpark transformation pipelines.",
        "Modular backend services for stream ingestion and distributed processing.",
        "Fault tolerance and stream reliability improved through queue optimization strategies.",
        "Tuned for processing efficiency and scalability in Linux environments.",
      ],
    },
    {
      meta: "2024 · Hackathon Runner-Up",
      title: "Real-Time Event Ticket Booking System",
      stack: "Python · Flask · Redis · MySQL",
      lead: "A real-time booking platform with dynamic seat allocation and payment workflow integration — built in a 24-hour hackathon and awarded runner-up.",
      points: [
        "Concurrent booking logic to prevent duplicate reservations under peak traffic.",
        "Redis caching for fast session handling and booking responsiveness.",
        "Integrated payment workflow with dynamic seat allocation.",
      ],
    },
  ],
};
